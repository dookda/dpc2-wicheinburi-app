...
export class HomePage {
  ...
  loadMap() {
    ...
    // overlay map
    const mapUrl = 'http://map.nu.ac.th/gs-alr2/ows?';
    const cgiUrl = 'http://www.cgi.uru.ac.th/geoserver/ows?';

    this.prov = L.tileLayer.wms(mapUrl, {
    ...
    this.vill = L.tileLayer.wms(mapUrl, {
    ...
    this.tk_hp = L.tileLayer.wms(cgiUrl, {
